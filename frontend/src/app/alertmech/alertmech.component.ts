...
@Component({
  selector: 'app-alertmech',
  templateUrl: './alertmech.component.html',
  styleUrls: ['./alertmech.component.css']
})
export class AlertmechComponent implements OnInit {
  ...
  AndonOpenAlerts() {
    this.service.getAndonOpenMechAlerts().subscribe((data: any) => {
