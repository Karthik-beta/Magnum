...
@Component({
  selector: 'app-alertresetting',
  templateUrl: './alertresetting.component.html',
  styleUrls: ['./alertresetting.component.css']
})
export class AlertresettingComponent implements OnInit {
  ...
  AndonOpenAlerts() {
    this.service.getAndonOpenResettingAlerts().subscribe((data: any) => {
