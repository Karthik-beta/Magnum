...
@Component({
  selector: 'app-alertquality',
  templateUrl: './alertquality.component.html',
  styleUrls: ['./alertquality.component.css']
})
export class AlertqualityComponent implements OnInit {
  ...
  AndonOpenAlerts() {
    this.service.getAndonOpenQualityAlerts().subscribe((data: any) => {
