...
@Component({
  selector: 'app-alertengineering',
  templateUrl: './alertengineering.component.html',
  styleUrls: ['./alertengineering.component.css']
})
export class AlertengineeringComponent implements OnInit {
  ...
  AndonOpenAlerts() {
    this.service.getAndonOpenEngineeringAlerts().subscribe((data: any) => {
